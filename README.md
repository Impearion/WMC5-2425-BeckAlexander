...
1. Finish either the JavaScript Course on Codecademy or the one from freeCodeCamp
   ...
   |-----------|-----------|-----------|-----------|
   | [Codecademy - Introdcution to javaScript](https://www.codecademy.com/learn/introduction-to-javascript)|   15h       | 66%       | no       |
...
4. Work through the following video about Node.js and Express
   ...
   | Task      | Duration| Progress (time or %) | Completed |
   |-----------|-----------|-----------|-----------|
   | [Node.js and Express.js - Full Course](https://www.youtube.com/watch?app=desktop&v=Oe421EPjeBE) |    8h 17min      | 90%      | no       |
